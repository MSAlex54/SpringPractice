...
public class AppPersistConfig {
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/spring_mvc_2?useUnicode=true&serverTimezone=UTC");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        //FactoryBean <EntittyManagerFactory
        LocalContainerEntityManagerFactoryBean factory = new LocalContainerEntityManagerFactoryBean();

        //Задаем источники подключения
        ...
        //Указание пакета, в котором будут находится классы-сущности
        factory.setPackagesToScan("ru.geekbrains.persist");
